...
> v3.2 — Полный редизайн интерфейса · Карта мира по центру · Колонка DX Spots на всю высоту · Градиентные полосы диапазонов · График Bz как отдельная панель · 14 языков через внешние пакеты
