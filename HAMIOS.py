...
# ── Vereenvoudigde continent polygonen  (lon, lat) ────────────────────────────
_CONTINENTS = [
    # Noord-Amerika
    [(-168,72),(-140,70),(-115,71),(-95,74),(-83,68),(-78,62),(-70,55),
     (-55,47),(-67,47),(-70,43),(-75,35),(-80,25),(-88,15),(-77,8),
     (-77,18),(-90,18),(-104,19),(-117,31),(-120,34),(-124,37),(-124,49),
     (-131,56),(-140,60),(-154,59),(-167,62),(-168,72)],
    # Groenland
    [(-72,76),(-55,83),(-18,83),(-17,77),(-25,68),(-44,60),(-54,60),
     (-66,65),(-72,76)],
    # Zuid-Amerika
    [(-78,12),(-60,11),(-50,6),(-35,-4),(-35,-10),(-38,-15),(-40,-22),
     (-44,-23),(-50,-30),(-52,-34),(-58,-38),(-65,-42),(-65,-54),
     (-70,-56),(-75,-52),(-80,-36),(-80,-5),(-78,12)],
    # Europa (west)
    [(-10,36),(-9,39),(-10,44),(-5,44),(0,44),(5,44),(8,44),(5,48),
     (0,51),(2,51),(2,54),(5,55),(8,56),(5,58),(0,62),(-5,58),
     (-3,56),(-6,54),(-8,52),(-10,44),(-10,36)],
    # Scandinavië
    [(5,58),(8,58),(10,58),(14,55),(18,56),(22,56),(24,60),(28,70),
     (26,72),(20,70),(14,66),(10,63),(5,58)],
    # Oost-Europa / Rusland (west)
    [(10,55),(14,55),(18,56),(22,56),(24,60),(28,60),(32,60),(36,56),
     (36,50),(32,46),(28,46),(26,44),(22,44),(18,48),(14,48),(10,50),(10,55)],
    # Afrika
    [(-18,16),(-15,12),(-10,8),(0,5),(10,5),(10,0),(10,-5),(12,-18),
     (18,-28),(22,-35),(28,-35),(32,-28),(36,-20),(40,-12),(42,0),(38,8),
     (42,12),(44,12),(42,18),(38,18),(32,22),(32,30),(35,38),(30,38),
     (24,36),(10,37),(5,37),(0,30),(-8,22),(-18,16)],
    # Azië (vasteland)
    [(26,42),(32,42),(36,38),(42,38),(48,28),(56,22),(62,22),(68,22),
     (76,10),(80,12),(80,20),(72,22),(68,22),(62,22),(68,26),(74,30),
     (78,32),(82,28),(90,28),(95,25),(100,22),(106,20),(110,20),(115,22),
     (120,22),(122,24),(126,22),(130,20),(135,22),(130,32),(132,34),
     (136,36),(140,42),(132,42),(128,48),(122,48),(118,52),(110,52),
     (100,50),(92,52),(82,56),(76,56),(72,56),(68,60),(64,60),(60,60),
     (56,58),(52,52),(48,50),(44,48),(40,48),(36,48),(32,48),(28,46),(26,42)],
    # Indisch subcontinent
    [(62,22),(68,22),(72,20),(76,8),(80,8),(82,12),(80,20),(72,22),(62,22)],
    # Maleisisch schiereiland
    [(100,6),(103,2),(104,1),(106,2),(105,6),(103,8),(100,6)],
    # Borneo
    [(108,2),(110,4),(114,6),(116,4),(118,2),(116,0),(114,-2),(110,-2),(108,2)],
    # Sumatra
    [(96,4),(100,4),(104,2),(106,0),(104,-4),(100,-4),(96,4)],
    # Japan
    [(130,32),(132,34),(134,36),(137,36),(140,40),(141,42),(140,44),
     (138,44),(136,36),(132,34),(130,32)],
    # Australië
    [(114,-22),(118,-20),(122,-18),(128,-14),(136,-12),(140,-16),(144,-18),
     (148,-20),(152,-24),(154,-28),(152,-34),(148,-38),(144,-40),(140,-38),
     (136,-36),(130,-32),(126,-34),(122,-34),(116,-32),(114,-26),(114,-22)],
    # Nieuw-Zeeland (noord)
    [(172,-36),(175,-38),(178,-38),(178,-36),(175,-34),(172,-36)],
    # VK (vereenvoudigd)
    [(-5,50),(-3,50),(0,51),(2,52),(1,54),(-2,55),(-4,55),(-5,54),(-8,52),(-5,50)],
    # IJsland
    [(-24,63),(-14,65),(-8,65),(-8,64),(-24,63)],
    # Antarctica
    [(-180,-68),(-120,-64),(-60,-70),(0,-68),(60,-66),(120,-66),(180,-68),
    ...
    def _draw_map(self):
        ...
        if getattr(self, "_map_base_size", None) != cache_key:
            if os.path.exists(MAP_FILE):
                ...
                # Fallback: vereenvoudigde polygoonkaart tijdens download
                src = Image.new("RGB", (W, H), MAP_OCEAN)
                d   = ImageDraw.Draw(src)
                for poly in _CONTINENTS:
                    pts = [_ll_to_xy(la, lo, W, H) for lo, la in poly]
                    if len(pts) >= 3:
                        d.polygon(pts, fill=MAP_LAND, outline=MAP_COAST)
                # Downloaddmelding
                d.text((6, 4), "⬇ NASA-kaart wordt gedownload…",
                       fill=MAP_GRID)
